...
const questions: Question[] = [
  ...
  {
    q: 'Đạo hàm của f(x) = ln(cos(x)) là?',
    options: ['sin(x)', '-tan(x)', 'cot(x)', '1/cos(x)'],
    ans: 1,
  },
  { q: 'Tích phân I = ∫(từ 0 đến 1) x*e^x dx bằng?', options: ['1', 'e', 'e - 1', '0'], ans: 0 },
  {
    q: 'Chuỗi số ∑(n=1 đến ∞) 1/(n*(n+1)) hội tụ về?',
    options: ['1', '0', 'Vô cùng', '1/2'],
    ans: 0,
  },
  {
    q: 'Bán kính hội tụ R của chuỗi lũy thừa ∑ (x^n)/n! là?',
    options: ['0', '1', 'e', '+∞'],
    ans: 3,
  },
  {
    q: 'Gradient của hàm f(x,y) = x^2 + y^2 tại điểm (1,2) là?',
    options: ['(1, 2)', '(2, 4)', '(4, 2)', '(2, 2)'],
    ans: 1,
  },
  {
    q: 'Đạo hàm riêng cấp 2 f_xy của f(x,y) = x^3*y^2 là?',
    options: ['6x^2*y', '3x^2*y^2', '2x^3*y', '6x*y'],
    ans: 0,
  },
  {
    q: 'Điểm dừng của hàm f(x,y) = x^2 + xy + y^2 là?',
    options: ['(1,1)', '(0,0)', '(-1,1)', 'Không có'],
    ans: 1,
  },
  {
    q: 'Tích phân kép ∫∫D dxdy với D: x^2 + y^2 <= 1 bằng?',
    options: ['1', '2π', 'π', 'π/2'],
    ans: 2,
  },
  {
    q: 'Diện tích mặt cầu bán kính R trong R^3 là?',
    options: ['4πR^2', '4/3πR^3', '2πR', 'πR^2'],
    ans: 0,
  },
  {
    q: 'Thể tích khối cầu bán kính R tính bằng tích phân bội 3 là?',
    options: ['4πR^2', '4/3πR^3', '1/3πR^3', '2/3πR^3'],
    ans: 1,
  },
  {
    q: 'Tính công của lực F=(y, x) dọc theo đường cong kín C bất kỳ?',
    options: ['1', '2π', '0', 'Diện tích C'],
    ans: 2,
  },
  {
    q: "Nghiệm tổng quát của PT vi phân y' = y là?",
    options: ['y = C*x', 'y = C*e^x', 'y = e^C*x', 'y = ln(x)+C'],
    ans: 1,
  },
  {
    q: "Nghiệm của PT vi phân y'' + y = 0 là?",
    options: ['C1*cos(x) + C2*sin(x)', 'C*e^x', 'C1*e^x + C2*e^-x', 'C*x^2'],
    ans: 0,
  },
  {
    q: 'Theo định lý Green, ∫C Pdx + Qdy = ∫∫D (...) dxdy. Biểu thức trong ngoặc là?',
    options: ["P'_x - Q'_y", "Q'_x - P'_y", "P'_y - Q'_x", "Q'_y - P'_x"],
    ans: 1,
  },
  {
    q: 'Hệ số a_0 trong chuỗi Fourier của hàm lẻ f(x) = x trên (-π, π) bằng?',
    options: ['1', 'π', '0', '2π'],
    ans: 2,
  },
  { q: 'Biến đổi Laplace L{1} của hàm f(t) = 1 là?', options: ['1', 's', '1/s^2', '1/s'], ans: 3 },
  {
    q: 'Tích phân đường loại 1 không phụ thuộc vào yếu tố nào?',
    options: ['Hàm dưới dấu TP', 'Đường lấy TP', 'Hướng của đường cong', 'Độ dài cung'],
    ans: 2,
  },
  {
    q: 'Định lý Gauss-Ostrogradsky chuyển tích phân mặt loại 2 thành?',
    options: ['TP đường', 'TP kép', 'TP bội 3', 'TP xác định'],
    ans: 2,
  },
  {
    q: "Nghiệm của PT y' + y/x = sin(x)/x là?",
    options: ['y = (C - cos(x))/x', 'y = C*sin(x)', 'y = C*x + cos(x)', 'y = e^x / x'],
    ans: 0,
  },
]
